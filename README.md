...
values. You can manually force accelerometer and magnetometer calibration by pressing the btn0 button during the onscreen countdown prior to gyro calibration. For accelerometer calibration
place the unit undisturbed on a horizontal surface. For magnetometer calibration, slowly and smoothly wave the unit with a figure-of-8 motion while turning around and rotating the unit so that 
samples can be obtained with all possible 3D orientations. Do this away from large metal objects.
