...
## LCD Fonts
You have a choice of fonts for the large digit display fields. Uncomment only one of the `#include font_xxx.h` in `lcd7565.cpp` and re-build the firmware. The fonts were generated by [thedotfactory](https://github.com/pavius/The-Dot-Factory).
